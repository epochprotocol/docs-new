...
Protocol and action are identified by **keccak256 hashes of their string names**, not plain text. See [Protocol Identifiers](./06-appendices/protocol-identifiers.md).
...
- [Quickstart](./04-integration-guides/quickstart.md) — hands-on integration
